unit SmartInspect.Mobile;

//   Адаптация "Smart Inspect Сore" для мобильных приложений Android
//
//   Contains the definitions and implementations for the core types of the
//   SmartInspect Delphi library. To get started, please see the two most
//   important classes of the SmartInspect concept: TSmartInspectCore and
//   TSiSessionCore.
...
type
  ...
  //   a particular error in the TSmartInspectCore.OnError event.
  // </remarks>
  // <threadsafety>
  ...
  // <summary>
  //   Used to report errors concerning the TSmartInspectCore.LoadConnections
  //   method.
  // </summary>
  // <remarks>
  //   This exception is used to report errors concerning the
  //   TSmartInspectCore.LoadConnections method. This method is able to load a
  //   <link TSmartInspectCore.Connections, connections string> from a file.
  ...
  //   the TSmartInspectCore.OnError event. Please note, that, if a connections
  //   string can be read correctly, but is found to be invalid then this
  //   exception type will not be used. The TSmartInspectCore.LoadConnections
  ...
  //   public
  //     procedure OnError(ASender: TSmartInspectCore; AException: Exception);
  //   end;
  //
  // procedure TEventTest.OnError(ASender: TSmartInspectCore;
  ...
  // <summary>
  //   Used to report errors concerning the TSmartInspectCore.LoadConfiguration
  //   method.
  // </summary>
  // <remarks>
  //   This exception is used to report errors concerning the
  //   TSmartInspectCore.LoadConfiguration method. This method is able to load a
  ...
  //   the TSmartInspectCore.OnError event. Please note, that, if a connections
  //   string can be read correctly, but is found to be invalid then this
  //   exception type will not be used. The TSmartInspectCore.LoadConfiguration
  //   method will use the ESiInvalidConnectionsError in this case.
  // </remarks>
  // <threadsafety>
  //   This class is not guaranteed to be threadsafe.
  ...
  //   in the TSmartInspectCore.OnError event about the protocol which
  //   caused the error.
  // </remarks>
  // <threadsafety>
  //   This class is not guaranteed to be threadsafe.
  ...
  //   TSmartInspectCore class.
  // </summary>
  // <remarks>
  //   An invalid syntax, unknown protocols or inexistent options in the
  //   <link TSmartInspectCore.Connections, connections string> will result
  //   in an ESiInvalidConnectionsError exception. This exception type is
  //   used by the Connections property of the TSmartInspectCore class.
  // </remarks>
  // <threadsafety>
  //   This class is not guaranteed to be threadsafe.
  // </threadsafety>
  ...
  //
  //   Please see TSmartInspectCore.Resolution for details.
  // </remarks>
  ...
  (
    ...
    //   TSmartInspectCore.Resolution for details.
    // </summary>
  ...
  public
    ...
    //   during development and debugging. See TSmartInspectCore.Resolution
    //   for details.
    //
    ...
    //   the general limitations (see TSmartInspectCore.Resolution) of
  ...
  //   TSiSessionCore.LogCustomContext method and TSiViewerContext class.
  // </remarks>
  ...
  // <summary>
  //   Used in the LogSource methods of the TSiSessionCore class to specify
  ...
  (
    // <summary>
    //   Instructs the TSiSessionCore.LogSource methods to use syntax
  ...
  //   look at the corresponding TSiSessionCore.ClearAll method.
  // </remarks>
  ...
  // </summary>
  // <remarks>
  //   Please see the TSmartInspectCore.Level and TSmartInspectCore.DefaultLevel
  ...
  {$message warn 'todo'}
  TSiStringBuilder = class(TStringBuilder)
  public
  ...
  //   <link TSmartInspectCore.Connections, connections string> of the
  //   TSmartInspectCore class. Please see TSmartInspectCore.SetVariable for
  //   more information.
  // </remarks>
  // <threadsafety>
  //   This class is fully threadsafe.
  ...
  public
    ...
    //   documentation of the TSmartInspectCore.Connections property.
    // </remarks>
    // <exception>
    // <table>
    //   Exception Type           Condition
  ...
  //   to the TSmartInspectCore.LoadConfiguration method.
  // </remarks>
  // <threadsafety>
  //   This class is not guaranteed to be threadsafe.
  // </threadsafety>
  ...
  public
    ...
    //   <link TSmartInspectCore.Connections, connections> of a TSmartInspectCore
    ...
    //   if this packet has been created by the TSiSessionCore class and
    //   is processed by a related TSmartInspectCore object which has one
    ...
    //   the TSiSessionCore class and is processed by a related
    //   TSmartInspectCore object which has one or more connections which
  ...
  //   all logging methods in the TSiSessionCore class.
  // </summary>
  // <remarks>
  ...
  //   in the TSiSessionCore class, like, for example, TSiSessionCore.LogMessage,
  //   TSiSessionCore.LogObject or TSiSessionCore.LogSql.
  //
  ...
  public
    ...
    //   use high-resolution timestamps. See TSmartInspectCore.Resolution
  ...
  //   <link TSiSessionCore.ClearAll, reset the Console>.
  // </remarks>
  // <threadsafety>
  //   This class is not guaranteed to be threadsafe. However, instances
  //   of this class will normally only be used in the context of a single
  ...
  //   methods in the TSiSessionCore classes.
  // </summary>
  // <remarks>
  ...
  //   Enter-/Leave methods in the TSiSessionCore class.
  // </summary>
  // <remarks>
  ...
  //   TSiProtocol.Dispatch and TSmartInspectCore.Dispatch methods.
  //
  ...
  //   their identifier in the <link TSmartInspectCore.Connections,
  ...
  protected
    ...
    //   as used by the TSmartInspectCore.Dispatch method. This method
    ...
    //   the Dispatch and TSmartInspectCore.Dispatch methods.
    //
    ...
    // </param>
    // <seealso cref="TSmartInspectCore.Dispatch"/>
    // <remarks>
  ...
  public
    ...
    // </summary>
    // <remarks>
    //   The caption is used in the TSmartInspectCore.Dispatch method to
    ...
    //   not use the TSmartInspectCore.Dispatch method, the caption option can
    //   safely be ignored.
    //
    //   For more information, please refer to the documentation of the
    //   Dispatch and TSmartInspectCore.Dispatch methods.
    // </remarks>
  ...
  //   <link TSmartInspectCore.Connections, connections string>. Please see
  ...
  protected
    ...
    //   <link TSmartInspectCore.Connections, connections string>), the default
    //   filename is set to 'log.sil'. When using text log files ('text'
    //   in the <link TSmartInspectCore.Connections, connections string>), the
  ...
  //   <link TSmartInspectCore.Connections, connections string>. See the
  ...
  public
    ...
    //   <link TSmartInspectCore.Connections, connections string> just like
  ...
  //   the SmartInspect Delphi library. See the TSiSessionCore.LogCustomContext
  ...
  //   methods around <link TSiSessionCore.LogCustomContext, LogCustomContext>
  ...
  //   log methods around <link TSiSessionCore.LogCustomContext, LogCustomContext>
  ...
  // <summary>
  //   Used in the TrackMethod methods of the TSiSessionCore class.
  // </summary>
  // <remarks>
  //   For an explanation of this interface please refer to the
  //   documentation of the TSiSessionCore.TrackMethod method.
  // </remarks>
  ...
  //   TSiSessionCore.EnterMethod method in the constructor Create and
  //   the TSiSessionCore.LeaveMethod method in the destructor Destroy.
  //
  ...
  public
    ...
    constructor Create(const ALevel: TSiLevel; const ASession: TSiSessionCore;
  ...
  // <summary>
  //   This is the event handler type for the TSmartInspectCore.OnFilter
  //   event.
  // </summary>
  // <param name="ASender">The object which fired the event.</param>
  // <param name="APacket">
  ...
  TSiFilterEvent = procedure (ASender: TSmartInspectCore;
    APacket: TSiPacket; var ACancel: Boolean) of object;

  // <summary>
  //   This is the event handler type for the TSmartInspectCore.OnProcessFlow
  //   event.
  // </summary>
  // <param name="ASender">The object which fired the event.</param>
  ...
  TSiProcessFlowEvent = procedure (ASender: TSmartInspectCore;
    AProcessFlow: TSiProcessFlow) of object;

  // <summary>
  //   This is the event handler type for the TSmartInspectCore.OnError
  //   event.
  // </summary>
  // <param name="ASender">The object which fired the event.</param>
  // <param name="AException">The occurred exception.</param>
  ...
  TSiErrorEvent = procedure (ASender: TSmartInspectCore;
    AException: Exception) of object;

  // <summary>
  //   This is the event handler type for the TSmartInspectCore.OnWatch
  //   event.
  // </summary>
  // <param name="ASender">The object which fired the event.</param>
  // <param name="AWatch">
  ...
  TSiWatchEvent = procedure (ASender: TSmartInspectCore;
    AWatch: TSiWatch) of object;

  // <summary>
  //   This is the event handler type for the TSmartInspectCore.OnLogEntry
  //   event.
  // </summary>
  // <param name="ASender">The object which fired the event.</param>
  // <param name="ALogEntry">
  ...
  TSiLogEntryEvent = procedure (ASender: TSmartInspectCore;
    ALogEntry: TSiLogEntry) of object;

  // <summary>
  //   This is the event type for the TSmartInspectCore.OnControlCommand
  //   event.
  // </summary>
  // <param name="ASender">The object which fired the event.</param>
  ...
  TSiControlCommandEvent = procedure (ASender: TSmartInspectCore;
  ...
  // </summary>
  // <remarks>
  //   This class is used by the TSmartInspectCore class to customize the
  //   default property values for newly created sessions. Sessions
  //   that will be created by or passed to the AddSession method of
  //   the TSmartInspectCore class will be automatically configured with
  //   the values of the TSmartInspectCore.SessionDefaults property.
  // </remarks>
  // <threadsafety>
  //   This class is guaranteed to be threadsafe.
  // </threadsafety>
  ...
  private
    ...
    FColor: TColor;
  protected
    procedure Assign(const ASession: TSiSessionCore);
  public
    ...
    // </summary>
    // <remarks>
    //   Please see TSiSessionCore.Active for general information about the
    ...
    // </summary>
    // <remarks>
    //   Please see TSiSessionCore.Color for general information about the
    ...
    // </summary>
    // <remarks>
    //   Please see TSiSessionCore.Level for general information about the
  ...
  // <summary>
  //   TSmartInspectCore is the most important class in the SmartInspect
  //   Delphi library. It is an interface for the protocols, packets
  //   and sessions and is responsible for the error handling.
  // </summary>
  // <remarks>
  //   The TSmartInspectCore class is the most important class in the
  ...
  //
  //   The TSmartInspectCore class offers several properties for controlling
  ...
  //   which specify the log level of an TSmartInspectCore object and its
  //   related sessions.
  //
  //   Additionally, the TSmartInspectCore class acts as parent for
  //   sessions, which contain the actual logging methods, like, for
  //   example, TSiSessionCore.LogMessage or TSiSessionCore.LogObject. It is
  //   possible and common that several different sessions have the same
  //   parent and thus share the same connections. The TSiSessionCore class
  ...
  //   the Console by calling the TSiSessionCore.ClearLog method.
  //
  //   To accomplish these different tasks the SmartInspect concept uses
  //   several different packets. The TSmartInspectCore class manages these
  ...
  //   the Connections property if the <link TSmartInspectCore.Connections,
  ...
  TSmartInspectCore = class(TObject)
  private
  ...
  private
     class var FCurrentProcessId: Cardinal;
     class var FNextThreadId : TThreadId;
     class threadvar FCurrentThreadId : TThreadId;
  ...
  protected
    ...
    // <summary>
    //   Invokes the TSmartInspectCore.OnFilter event handler and determines
    ...
    // <remarks>
    //   Derived classes can override this method to intercept the
    //   TSmartInspectCore.OnFilter event. This method is always called in
    ...
    // <summary>
    //   Invokes the TSmartInspectCore.OnError event handlers.
    // </summary>
    // <param name="AException">The occurred exception.</param>
    // <remarks>
    //   Derived classes can override this method to intercept the
    //   TSmartInspectCore.OnError event.
    // </remarks>

    procedure DoError(const AException: Exception); virtual;

    // <summary>
    //   Invokes the TSmartInspectCore.OnProcessFlow event handlers.
    // </summary>
    // <param name="AProcessFlow">
    ...
    // <remarks>
    //   Derived classes can override this method to intercept the
    //   TSmartInspectCore.OnProcessFlow event. This event is always called
    ...
    // <summary>
    //   Invokes the TSmartInspectCore.OnWatch event handlers.
    // </summary>
    // <param name="AWatch">
    ...
    // <remarks>
    //   Derived classes can override this method to intercept the
    //   TSmartInspectCore.OnWatch event. This event is always called in an
    //   exception-safe context.
    // </remarks>
    ...
    // <summary>
    //   Invokes the TSmartInspectCore.OnLogEntry event handlers.
    // </summary>
    // <param name="ALogEntry">
    ...
    // <remarks>
    //   Derived classes can override this method to intercept the
    //   TSmartInspectCore.OnLogEntry event. This event is always called
    //   in an exception-safe context.
    // </remarks>
    ...
    // <summary>
    //   Invokes the TSmartInspectCore.OnControlCommand event handlers.
    // </summary>
    // <param name="AControlCommand">
    ...
    // <remarks>
    //   Derived classes can override this method to intercept the
    //   TSmartInspectCore.OnControlCommand event. This method is always
    ...
    procedure UpdateSession(const ASession: TSiSessionCore;
      const ATo, AFrom: UnicodeString);
  public

    // <summary>
    //   Creates and initializes a new instance of the TSmartInspectCore class.
    // </summary>
    // <param name="AAppName">
    ...
    //   lists and all synchronizers. In particular, all <link TSiSessionCore,
    ...
    //   <link TSmartInspectCore.Connections, connections string>. When
    ...
    // <summary>
    //   Overloaded. Adds and returns a new TSiSessionCore instance with this
    //   TSmartInspectCore object set as parent and optionally saves it for
    //   later access.
    // </summary>
    ...
    // </param>
    // <returns>The new TSiSessionCore instance.</returns>
    // <remarks>
    //   This method allocates a new session with this TSmartInspectCore
    ...
    //   method will be freed automatically when the TSmartInspectCore object
    ...
    function AddSession(const ASessionName: UnicodeString;
      const AStore: Boolean = False): TSiSessionCore; overload;

    // <summary>
    //   Overloaded. Adds an existing TSiSessionCore instance to the internal
    ...
    //   automatically when the TSmartInspectCore object is destroyed. To
    ...
    procedure AddSession(const ASession: TSiSessionCore); overload;
    ...
    // </param>
    // <remarks>
    //   TSiSessionCore instances, created with the AddSession method, should
    //   only be manually freed using this DeleteSession method. It frees
    //   the TSiSessionCore instance correctly and removes it from the internal
    //   session list.
    //
    ...
    procedure DeleteSession(const ASession: TSiSessionCore);
    ...
    function GetSession(const ASessionName: UnicodeString): TSiSessionCore; virtual;


    // Симуляция получение уникалного номера для потока на Amdroid делаем чере
    // переменные счетчика, т.к. Api фцнункций нормальных для этого в ОС не нашел
    // А реузльтат этих TThread.Current.ThreadID; и GetCurrentThreadId; не понятен
    class procedure SiInitCurrentProcessId;
    class function SiGetCurrentProcessId: Cardinal; inline;
    class function SiGetCurrentThreadId: TThreadID;
    ...
    property Sessions[const ASessionName: UnicodeString]: TSiSessionCore read
      GetSession; default;
    ...
    // <remarks>
    //   This method loads the <link TSmartInspectCore.Connections,
    ...
    //   if this TSmartInspectCore instance is already enabled.
    //
    //   The OnError event is used to notify the parent application if
    //   the specified file cannot be opened or does not contain a
    //   <link TSmartInspectCore.Connections, connections string>. The
    //   <link TSmartInspectCore.Connections, connections string> and the
    //   <link TSmartInspectCore.Enabled, enabled status> of this instance
    ...
    // <summary>
    //   Loads the properties and sessions of this TSmartInspectCore instance
    //   from a file.
    // </summary>
    // <param name="AFileName">
    //   The name of the file to load the configuration from.
    ...
    //   TSmartInspectCore object from a file. This file should be a plain
    ...
    //   TSmartInspectCore instance after the deployment of an application.
    ...
    //   the customer. Now, to load the TSmartInspectCore properties from
    ...
    //   the corresponding TSmartInspectCore properties and their types:
    //
    //   <table>
    //   Value          Property       Type
    //   -              -              -
    ...
    //   any stored sessions of this TSmartInspectCore object. Sessions that
    ...
    //   the TSmartInspectCore.OnLogEntry event is fired.
    // </remarks>
    ...
    //   TSmartInspectCore.OnControlCommand event is fired.
    // </remarks>
    ...
    //   TSmartInspectCore.OnProcessFlow event is fired.
    // </remarks>
    ...
    //  filter test, it will be logged and the TSmartInspectCore.OnWatch
    //   event is fired.
    // </remarks>
    ...
    //   disconnect.
    //
    //   Additionally, every TSiSessionCore method evaluates if its parent
    ...
    //   use the TSmartInspectCore instance and its related sessions.
    //
    //   <b>Please note:</b> If one or more connections of this
    //   TSmartInspectCore object operate in
    //   <link TSiProtocol.IsValidOption, asynchronous protocol mode>,
    ...
    // <summary>
    //   Specifies all connections used by a TSmartInspectCore instance.
    // </summary>
    // <remarks>
    ...
    // <summary>
    //   Represents the default log level of this TSmartInspectCore
    //   instance and its related sessions.
    // </summary>
    // <seealso cref="TSiLevel"/>
    // <seealso cref="TSmartInspectCore.Level"/>
    // <remarks>
    //   The DefaultLevel property of this TSmartInspectCore instance
    //   represents the default log level used by its corresponding
    //   sessions. The default value of this property is lvMessage.
    //
    //   Every method in the TSiSessionCore class which makes use of the
    ...
    // <summary>
    //   Represents the log level of this TSmartInspectCore instance and its
    //   related sessions.
    // </summary>
    // <seealso cref="TSiLevel"/>
    // <seealso cref="TSmartInspectCore.DefaultLevel"/>
    // <remarks>
    //   The Level property of this TSmartInspectCore instance represents
    ...
    //
    //   Every method (except the Clear method family) in the TSiSessionCore
    ...
    //
    //   The log level for a method in the TSiSessionCore class can either be
    //   specified explicitly by passing a Level argument or implicitly
    //   by using the <link DefaultLevel, default level>. Every method
    //   in the TSiSessionCore class which makes use of the parent's log level
    ...
    // <summary>
    //   Specifies the timestamp resolution mode for this TSmartInspectCore
    //   object.
    // </summary>
    // <seealso cref="TSiClockResolution"/>
    // <remarks>
    ...
    //   properties, please refer to the documentation of the TSiSessionCore
    //   class.
    // </remarks>
    ...
    //   TEventTest = class(TObject)
    //   public
    //     procedure OnFilter(ASender: TSmartInspectCore; APacket: TSiPacket;
    //       var ACancel: Boolean);
    //   end;
    //
    // procedure TEventTest.OnFilter(ASender: TSmartInspectCore;
    ...
    //   connections of this TSmartInspectCore object should operate in
    //   <link TSiProtocol.IsValidOption, asynchronous protocol mode>,
    ...
    //   TEventTest = class(TObject)
    //   public
    //     procedure OnLogEntry(ASender: TSmartInspectCore;
    //       ALogEntry: TSiLogEntry);
    //   end;
    //
    // procedure TEventTest.OnLogEntry(ASender: TSmartInspectCore;
    //   ALogEntry: TSiLogEntry);
    // begin
    ...
    //   TEventTest = class(TObject)
    //   public
    //     procedure OnWatch(ASender: TSmartInspectCore; AWatch: TSiWatch);
    //   end;
    //
    // procedure TEventTest.OnWatch(ASender: TSmartInspectCore; AWatch: TSiWatch);
    // begin
    ...
    //   TEventTest = class(TObject)
    //   public
    //     procedure OnProcessFlow(ASender: TSmartInspectCore;
    //       AProcessFlow: TSiProcessFlow);
    //   end;
    //
    // procedure TEventTest.OnProcessFlow(ASender: TSmartInspectCore;
    //   AProcessFlow: TSiProcessFlow);
    // begin
    ...
    //   TEventTest = class(TObject)
    //   public
    //     procedure OnControlCommand(ASender: TSmartInspectCore;
    //       AControlCommand: TSiControlCommand);
    //   end;
    //
    // procedure TEventTest.OnControlCommand(ASender: TSmartInspectCore;
    //   AControlCommand: TSiControlCommand);
    // begin
  ...
  // </summary>
  // <remarks>
  //   The TSiSessionCore class offers dozens of useful methods for sending
  //   any kind of data with the assistance of its <link TSiSessionCore.Parent,
  ...
  //   its <link TSiSessionCore.Parent, parent> is <link TSmartInspectCore.Enabled,
  //   disabled> or the <link TSmartInspectCore.Level, log level> is not
  //   sufficient.
  // </remarks>
  // <threadsafety>
  //   This class is fully threadsafe.
  ...
  protected
    ...
    // </returns>
    // <remarks>
    //   See the TSmartInspectCore.GetSession and TSmartInspectCore.AddSession
  ...
  public
    ...
    // <summary>
    //   Creates and initializes a TSiSessionCore instance.
    // </summary>
    // <param name="AParent">
    ...
    constructor Create(const AParent: TSmartInspectCore;
    ...
    //   to determine if information should be logged or not. When
    //   extending the TSiSessionCore class by adding new log methods to a
    ...
    //
    //   This method uses the <link TSmartInspectCore.DefaultLevel,
    //   default level> of the session's <link Parent, parent> as log
    //   level. For more information, please refer to the documentation
    //   of the <link TSmartInspectCore.DefaultLevel, DefaultLevel> property
    //   of the TSmartInspectCore class.
    // </remarks>
    ...
    // </summary>
    // <seealso cref="TSiSessionCore.AddCheckpoint"/>
    // <remarks>
    ...
    // </summary>
    // <seealso cref="TSiSessionCore.LogSeparator"/>
    // <seealso cref="TSiSessionCore.ResetCheckpoint"/>
    // <remarks>
    ...
    // <summary>
    //   Overloaded. Logs a UInt64 value with the default log level.
    // </summary>
    // <param name="AName">The variable name.</param>
    // <param name="AValue">The variable value.</param>
    // <remarks>
    //   This method logs the name and value of a UInt64 variable.
    //   A title like "name = 23" will be displayed in the Console.
    //
    //   This method uses the <link TSmartInspectCore.DefaultLevel,
    //   default level> of the session's <link Parent, parent> as log
    ...
    procedure LogUInt64(const AName: UnicodeString; const AValue: UInt64);
      overload;

    // <summary>
    //   Overloaded. Logs a UInt64 value with a custom log level.
    // </summary>
    // <param name="ALevel">The log level of this method call.</param>
    // <param name="AName">The variable name.</param>
    // <param name="AValue">The variable value.</param>
    ...
    procedure LogUInt64(const ALevel: TSiLevel; const AName: UnicodeString;
      const AValue: UInt64); overload;

    // <summary>
    //   Overloaded. Logs a UInt64 value with an optional hexadecimal
    //   representation and default log level.
    // </summary>
    // <param name="AName">The variable name.</param>
    // <param name="AValue">The variable value.</param>
    ...
    procedure LogUInt64(const ALevel: TSiLevel; const AName: UnicodeString;
      const AValue: UInt64; const AIncludeHex: Boolean); overload;
    ...
    // <summary>
    //   Overloaded. Logs the name and value of a UInt64 variable
    //   with the default log level.
    // </summary>
    // <param name="AName">The name of the variable.</param>
    // <param name="AValue">The UInt64 value of the variable.</param>
    // <remarks>
    //   This method just calls the LogUInt64 method.
    //
    //   This method uses the <link TSmartInspectCore.DefaultLevel,
    //   default level> of the session's <link Parent, parent> as log
    //   level. For more information, please refer to the documentation
    ...
    procedure LogValue(const AName: UnicodeString; const AValue: UInt64);
      overload;
    ...
    // <remarks>
    //   The TSiSessionCore class tracks a list of so called named counters.
    ...
    // <summary>
    //   Overloaded. Logs a UInt64 Watch with the default log level.
    // </summary>
    // <param name="AName">The name of the Watch.</param>
    // <param name="AValue">The value to display as Watch value.</param>
    // <seealso cref="TSiWatch"/>
    ...
    procedure WatchUInt64(const AName: UnicodeString;
      const AValue: UInt64); overload;

    // <summary>
    //   Overloaded. Logs a UInt64 Watch with a custom log level.
    // </summary>
    // <param name="ALevel">The log level of this method call.</param>
    // <param name="AName">The name of the Watch.</param>
    // <param name="AValue">The value to display as Watch value.</param>
    ...
    procedure WatchUInt64(const ALevel: TSiLevel; const AName: UnicodeString;
      const AValue: UInt64); overload;

    // <summary>
    //   Overloaded. Logs a UInt64 Watch with an optional hexadecimal
    //   representation and default log level.
    // </summary>
    // <param name="AName">The name of the Watch.</param>
    // <param name="AValue">The value to display as Watch value.</param>
    ...
    // <seealso cref="TSiWatch"/>
    // <remarks>
    //   This method logs a UInt64 Watch. You can specify if a
    //   hexadecimal representation should be included as well
    //   by setting the AIncludeHex parameter to true.
    //
    //   This method uses the <link TSmartInspectCore.DefaultLevel,
    ...
    procedure WatchUInt64(const AName: UnicodeString; const AValue: UInt64;
      const AIncludeHex: Boolean); overload;
    ...
    // <param name="AName">The name of the Watch.</param>
    // <param name="AValue">
    //   The UInt64 value to display as Watch value.
    // </param>
    // <remarks>
    //   This method just calls the WatchUInt64 method.
    //
    //   This method uses the <link TSmartInspectCore.DefaultLevel,
    //   default level> of the session's <link Parent, parent> as log
    //   level. For more information, please refer to the documentation
    ...
    procedure Watch(const AName: UnicodeString; const AValue: UInt64); overload;
    ...
    //   The UInt64 value to display as Watch value.
    // </param>
    // <remarks>This method just calls the WatchUInt64 method.</remarks>
    ...
    //   <link TSmartInspectCore.Enabled, enabled> in order to log information.
    //
    ...
    //   <link TSmartInspectCore.Enabled, Enabled> property of the <link
    //   Parent, parent>.
    // </remarks>
    ...
    // <summary>
    //   Represents the log level of this TSiSessionCore object.
    // </summary>
    // <remarks>
    //   Each TSiSessionCore object can have its own log level. A log
  ...
  // <summary>
  //   Manages and configures TSiSessionCore instances.
  // </summary>
  // <remarks>
  ...
  private
    ...
    procedure Configure(const ASession: TSiSessionCore; const AName: UnicodeString);
    procedure Assign(const ASession: TSiSessionCore; const AInfo: TSiSessionInfo);
  public
    ...
    //   passed to Add.
    //
    //   Please see the TSmartInspectCore.LoadConfiguration method for
    ...
    // <summary>
    //   Configures a passed TSiSessionCore instance and optionally saves
    //   it for later access.
    // </summary>
    // <param name="ASession">
    ...
    procedure Add(const ASession: TSiSessionCore; const AStore: Boolean);
    ...
    procedure Delete(const ASession: TSiSessionCore);
    ...
    procedure Update(const ASession: TSiSessionCore; const ATo, AFrom: UnicodeString);
    ...
    function Get(const AName: UnicodeString): TSiSessionCore;
    ...
    property Items[const AName: UnicodeString]: TSiSessionCore read Get; default;
    ...
    //   documentation of the TSiSessionCore class.
    // </remarks>

    property Defaults: TSiSessionDefaults read FDefaults;
  end;

function SiFormat(const AFmt: UnicodeString; const AArgs: array of const): UnicodeString;
...
const
  ...
  mcTransparent: TColor = TColors.SysWindow;
...
begin
  try
    var FullPath := TPath.GetFullPath(AFileName);
    var DirName := TPath.GetDirectoryName(FullPath);
    var Pattern := TPath.GetFileName(AFileName);
    var List := TDirectory.GetFiles(DirName, Pattern);
...
const
  ...
  SiDefaultColor = TColors.SysWindow;
...
begin
  ...
  FThreadId := TSmartInspectCore.SiGetCurrentThreadId;
  FProcessId := TSmartInspectCore.SiGetCurrentProcessId;
end;
...
var
  LValue: UnicodeString;
begin
  LValue := DateTimeToStr(AValue, TFormatSettings.Invariant);
...
var
  LValue: UnicodeString;
begin
  LValue := FloatToStr(AValue, TFormatSettings.Invariant);
  AppendKeyValue(AKey, LValue);
end;
...
begin
  LEntry := FloatToStr(AEntry, TFormatSettings.Invariant);
  AddRowEntry(LEntry);
end;
...
var
  LEntry: UnicodeString;
begin
  LEntry := DateTimeToStr(AEntry, TFormatSettings.Invariant);
  AddRowEntry(LEntry);
end;
...
begin
  ...
  if AAppend then
    LMode := fmOpenReadWrite + fmShareDenyWrite
  else
    LMode := fmCreate + fmOpenReadWrite + fmShareDenyWrite;
...
begin
  ...
  begin
    if TStopwatch.GetTimeStamp - FReconnectTickCount < FReconnectInterval then
    begin
...
begin
  ...
  try
    ...
    FReconnectTickCount := TStopwatch.GetTimeStamp;
  end;
end;
...
begin
  ...
  begin
    ...
    Move(ABuffer, Pointer(IntPtr(FBuffer) + FCount)^, ACount);
...
function TSmartInspectCore.AddSession(const ASessionName: UnicodeString;
  const AStore: Boolean): TSiSessionCore;
begin
  Result := TSiSessionCore.Create(Self, ASessionName);
  FSessions.Add(Result, AStore);
end;

procedure TSmartInspectCore.AddSession(const ASession: TSiSessionCore);
begin
  FSessions.Add(ASession, True);
end;

procedure TSmartInspectCore.Connect;
var
  I: Integer;
begin
  I := 0;
...
constructor TSmartInspectCore.Create(const AAppName: UnicodeString);
var
  LHostName: String;
...
procedure TSmartInspectCore.CreateConnections(const AConnections: UnicodeString);
var
...
procedure TSmartInspectCore.AddConnection(ASender: TSiConnectionsParser;
  AProtocol, AOptions: UnicodeString);
var
...
procedure TSmartInspectCore.DeleteSession(const ASession: TSiSessionCore);
begin
  FSessions.Delete(ASession);
end;

procedure TSmartInspectCore.UnsetVariable(const AKey: UnicodeString);
begin
  FVariables.Remove(AKey);
end;

destructor TSmartInspectCore.Destroy;
begin
  RemoveConnections;
...
procedure TSmartInspectCore.Disconnect;
var
  I: Integer;
begin
  I := 0;
...
procedure TSmartInspectCore.Dispatch(const ACaption: UnicodeString;
...
procedure TSmartInspectCore.DoControlCommand(
...
procedure TSmartInspectCore.DoError(const AException: Exception);
var
...
function TSmartInspectCore.DoFilter(const APacket: TSiPacket): Boolean;
var
...
procedure TSmartInspectCore.DoLogEntry(const ALogEntry: TSiLogEntry);
var
...
procedure TSmartInspectCore.DoProcessFlow(const AProcessFlow: TSiProcessFlow);
var
...
procedure TSmartInspectCore.DoWatch(const AWatch: TSiWatch);
var
...
function TSmartInspectCore.GetAppName: UnicodeString;
begin
  FCriticalSection.Enter;
  try
    Result := FAppName;
...
function TSmartInspectCore.GetOnControlCommand: TSiControlCommandEvent;
begin
  FEventLock.Enter;
  try
...
function TSmartInspectCore.GetOnError: TSiErrorEvent;
begin
  FEventLock.Enter;
  try
    Result := FOnError;
...
function TSmartInspectCore.GetOnFilter: TSiFilterEvent;
begin
  FEventLock.Enter;
  try
    Result := FOnFilter;
...
function TSmartInspectCore.GetOnLogEntry: TSiLogEntryEvent;
begin
  FEventLock.Enter;
  try
    Result := FOnLogEntry;
...
function TSmartInspectCore.GetOnProcessFlow: TSiProcessFlowEvent;
begin
  FEventLock.Enter;
  try
...
function TSmartInspectCore.GetOnWatch: TSiWatchEvent;
begin
  FEventLock.Enter;
  try
    Result := FOnWatch;
...
function TSmartInspectCore.GetSession(const ASessionName: UnicodeString): TSiSessionCore;
begin
  Result := FSessions[ASessionName];
end;

function TSmartInspectCore.GetSessionDefaults: TSiSessionDefaults;
begin
  Result := FSessions.Defaults;
end;

function TSmartInspectCore.GetVariable(const AKey: UnicodeString): UnicodeString;
begin
  Result := FVariables.Get(AKey);
end;

procedure TSmartInspectCore.LoadConnections(const AFileName: UnicodeString;
...
function TSmartInspectCore.Now: TDateTime;
begin
  Result := TSiClock.Now(FResolution);
end;

class function TSmartInspectCore.ReadConnections(const AFileName: UnicodeString;
  var AConnections: UnicodeString): Boolean;
const
...
procedure TSmartInspectCore.RemoveConnections;
begin
  Disconnect;
...
procedure TSmartInspectCore.ProcessPacket(const APacket: TSiPacket);
var
  I: Integer;
begin
  FCriticalSection.Enter;
...
procedure TSmartInspectCore.ProtocolError(ASender: TSiProtocol;
  AException: Exception);
begin
  DoError(AException);
end;

procedure TSmartInspectCore.SendControlCommand(
  const AControlCommand: TSiControlCommand);
begin
...
procedure TSmartInspectCore.SendLogEntry(const ALogEntry: TSiLogEntry);
begin
...
procedure TSmartInspectCore.SendProcessFlow(const AProcessFlow: TSiProcessFlow);
begin
...
procedure TSmartInspectCore.SendWatch(const AWatch: TSiWatch);
begin
...
procedure TSmartInspectCore.SetAppName(const AValue: UnicodeString);
begin
  FCriticalSection.Enter;
  try
    FAppName := AValue;
...
procedure TSmartInspectCore.SetConnections(const AValue: UnicodeString);
begin
  FCriticalSection.Enter;
  try
...
procedure TSmartInspectCore.SetEnabled(const AValue: Boolean);
begin
  FCriticalSection.Enter;
  try
    if AValue then
...
procedure TSmartInspectCore.SetOnControlCommand(
...
procedure TSmartInspectCore.SetOnError(const AValue: TSiErrorEvent);
begin
  FEventLock.Enter;
  try
    FOnError := AValue;
...
procedure TSmartInspectCore.SetOnFilter(const AValue: TSiFilterEvent);
begin
  FEventLock.Enter;
  try
    FOnFilter := AValue;
...
procedure TSmartInspectCore.SetOnLogEntry(const AValue: TSiLogEntryEvent);
begin
  FEventLock.Enter;
  try
    FOnLogEntry := AValue;
...
procedure TSmartInspectCore.SetOnProcessFlow(const AValue: TSiProcessFlowEvent);
begin
  FEventLock.Enter;
  try
...
procedure TSmartInspectCore.SetOnWatch(const AValue: TSiWatchEvent);
begin
  FEventLock.Enter;
  try
    FOnWatch := AValue;
...
procedure TSmartInspectCore.SetVariable(const AKey, AValue: UnicodeString);
begin
  FVariables.Put(AKey, AValue)
end;

procedure TSmartInspectCore.ApplyConnections(const AConnections: UnicodeString);
begin
  RemoveConnections;
...
function TSmartInspectCore.TryConnections(const AConnections: UnicodeString): Boolean;
begin
  Result := False;
...
procedure TSmartInspectCore.UpdateProtocols;
var
  I: Integer;
  LProtocol: TSiProtocol;
begin
...
procedure TSmartInspectCore.UpdateSession(const ASession: TSiSessionCore;
  const ATo, AFrom: UnicodeString);
begin
  FSessions.Update(ASession, ATo, AFrom);
end;

class function TSmartInspectCore.Version: UnicodeString;
begin
  Result := SiVersion;
end;

class function TSmartInspectCore.SiGetCurrentThreadId: TThreadID;
begin
  Result := TSmartInspectCore.FCurrentThreadId;

  if Result = 0 then
  begin
    // Идентификаторы потоков будем симулировать увеличением автоинкрементного сетчика
    Result := AtomicIncrement(TSmartInspectCore.FNextThreadId);
    TSmartInspectCore.FCurrentThreadId := Result;
  end;
end;

class procedure TSmartInspectCore.SiInitCurrentProcessId;
begin
  // Вызывать инициализацию будем один раз при старте главного потока
  // Симулируем идентификатора процесса как случаное число
  TSmartInspectCore.FCurrentProcessId := Abs(TGUID.NewGuid.ToString.GetHashCode) mod 10000;

  // Нумерация потоков начинается от единицы и начинается с главного потока
  TSmartInspectCore.FNextThreadId := 1;
  TSmartInspectCore.FCurrentThreadId := TSmartInspectCore.FNextThreadId;
end;

class function TSmartInspectCore.SiGetCurrentProcessId: Cardinal;
begin
  Result := TSmartInspectCore.FCurrentProcessId;
end;

procedure TSmartInspectCore.Disable;
begin
  if FEnabled then
  begin
    FEnabled := False;
...
procedure TSmartInspectCore.Enable;
begin
...
function TSmartInspectCore.FindProtocol(const ACaption: UnicodeString): TSiProtocol;
var
  I: Integer;
  LProtocol: TSiProtocol;
begin
...
procedure TSmartInspectCore.LoadConfiguration(const AFileName: UnicodeString);
var
...
procedure TSmartInspectCore.ApplyConfiguration(const AConfig: TSiConfiguration);
var
  LEnabled: Boolean;
  LConnections: UnicodeString;
begin
...
constructor TSiSessionCore.Create(const AParent: TSmartInspectCore;
  const ASessionName: UnicodeString);
begin
...
procedure TSiSessionCore.DecCounter(const AName: UnicodeString);
begin
  DecCounter(FParent.DefaultLevel, AName);
end;

procedure TSiSessionCore.DecCounter(const ALevel: TSiLevel;
...
destructor TSiSessionCore.Destroy;
begin
...
procedure TSiSessionCore.ResetColor;
begin
  Color := SiDefaultColor;
end;

procedure TSiSessionCore.ResetCounter(const AName: UnicodeString);
begin
  FCriticalSection.Enter;
  try
...
procedure TSiSessionCore.SetName(const AValue: UnicodeString);
begin
  FCriticalSection.Enter;
  try
    if FIsStored then
...
function TSiSessionCore.IsOn(const ALevel: TSiLevel): Boolean;
begin
  Result := FParent.Enabled and FActive and (ALevel >= FLevel) and
    (ALevel >= FParent.Level);
end;

function TSiSessionCore.IsOn: Boolean;
begin
  Result := FParent.Enabled and FActive;
end;

procedure TSiSessionCore.ExceptionHandler(ASender: TObject; AException: Exception);
begin
...
function TSiSessionCore.GetName: UnicodeString;
begin
  FCriticalSection.Enter;
  try
    Result := FName;
...
procedure TSiSessionCore.LogSeparator;
begin
  LogSeparator(FParent.DefaultLevel);
end;

procedure TSiSessionCore.LogSeparator(const ALevel: TSiLevel);
begin
  if IsOn(ALevel) then
  begin
...
procedure TSiSessionCore.ResetCallstack;
begin
  ResetCallstack(FParent.DefaultLevel);
end;

procedure TSiSessionCore.ResetCallstack(const ALevel: TSiLevel);
begin
  if IsOn(ALevel) then
  begin
...
procedure TSiSessionCore.EnterMethod(const AMethodName: UnicodeString);
begin
  EnterMethod(FParent.DefaultLevel, AMethodName);
end;

procedure TSiSessionCore.EnterMethod(const ALevel: TSiLevel;
  const AMethodName: UnicodeString);
begin
  if IsOn(ALevel) then
  begin
...
procedure TSiSessionCore.EnterMethod(const AMethodNameFmt: UnicodeString;
...
procedure TSiSessionCore.EnterMethod(const AInstance: TObject;
  const AMethodName: UnicodeString);
begin
...
procedure TSiSessionCore.LeaveMethod(const AMethodName: UnicodeString);
begin
  LeaveMethod(FParent.DefaultLevel, AMethodName);
end;

procedure TSiSessionCore.LeaveMethod(const ALevel: TSiLevel;
  const AMethodName: UnicodeString);
begin
  if IsOn(ALevel) then
  begin
...
procedure TSiSessionCore.LeaveMethod(const AMethodNameFmt: UnicodeString;
  const AArgs: array of const);
begin
...
procedure TSiSessionCore.LeaveMethod(const AInstance: TObject;
  const AMethodName: UnicodeString);
begin
...
procedure TSiSessionCore.EnterThread(const AThreadName: UnicodeString);
begin
  EnterThread(FParent.DefaultLevel, AThreadName);
end;

procedure TSiSessionCore.EnterThread(const ALevel: TSiLevel;
...
procedure TSiSessionCore.EnterThread(const AThreadNameFmt: UnicodeString;
  const AArgs: array of const);
begin
...
procedure TSiSessionCore.LeaveThread(const AThreadName: UnicodeString);
begin
  LeaveThread(FParent.DefaultLevel, AThreadName);
end;

procedure TSiSessionCore.LeaveThread(const ALevel: TSiLevel;
  const AThreadName: UnicodeString);
begin
  if IsOn(ALevel) then
  begin
  ...
  TSmartInspectCore.FCurrentThreadId := 0;
end;

procedure TSiSessionCore.LeaveThread(const AThreadNameFmt: UnicodeString;
  const AArgs: array of const);
begin
...
procedure TSiSessionCore.EnterProcess;
begin
  EnterProcess(FParent.DefaultLevel);
end;

procedure TSiSessionCore.EnterProcess(const ALevel: TSiLevel);
begin
  if IsOn(ALevel) then
  begin
...
procedure TSiSessionCore.EnterProcess(const AProcessName: UnicodeString);
begin
...
procedure TSiSessionCore.EnterProcess(const AProcessNameFmt: UnicodeString;
  const AArgs: array of const);
begin
...
procedure TSiSessionCore.LeaveProcess;
begin
  LeaveProcess(FParent.DefaultLevel);
end;

procedure TSiSessionCore.LeaveProcess(const ALevel: TSiLevel);
begin
  if IsOn(ALevel) then
  begin
...
procedure TSiSessionCore.LeaveProcess(const AProcessName: UnicodeString);
begin
...
procedure TSiSessionCore.LeaveProcess(const AProcessNameFmt: UnicodeString;
  const AArgs: array of const);
begin
...
procedure TSiSessionCore.LogColored(const AColor: TColor;
  const ATitle: UnicodeString);
begin
  LogColored(FParent.DefaultLevel, AColor, ATitle);
end;

procedure TSiSessionCore.LogColored(const ALevel: TSiLevel;
...
procedure TSiSessionCore.LogConditional(const ACondition: Boolean;
  const ATitleFmt: UnicodeString; const AArgs: array of const);
begin
...
procedure TSiSessionCore.LogConditional(const ALevel: TSiLevel;
...
procedure TSiSessionCore.LogDebug(const ATitle: UnicodeString);
begin
...
procedure TSiSessionCore.LogDebug(const ATitleFmt: UnicodeString;
  const AArgs: array of const);
begin
  if IsOn(lvDebug) then
  begin
...
procedure TSiSessionCore.LogVerbose(const ATitle: UnicodeString);
begin
...
procedure TSiSessionCore.LogVerbose(const ATitleFmt: UnicodeString;
  const AArgs: array of const);
begin
  if IsOn(lvVerbose) then
  begin
...
procedure TSiSessionCore.LogMessage(const ATitle: UnicodeString);
begin
...
procedure TSiSessionCore.LogMessage(const ATitleFmt: UnicodeString;
  const AArgs: array of const);
begin
  if IsOn(lvMessage) then
  begin
...
procedure TSiSessionCore.LogWarning(const ATitle: UnicodeString);
begin
...
procedure TSiSessionCore.LogWarning(const ATitleFmt: UnicodeString;
  const AArgs: array of const);
begin
  if IsOn(lvWarning) then
  begin
...
procedure TSiSessionCore.LogError(const ATitle: UnicodeString);
begin
  if IsOn(lvError) then
  begin
...
procedure TSiSessionCore.LogError(const ATitleFmt: UnicodeString;
  const AArgs: array of const);
begin
  if IsOn(lvError) then
  begin
...
procedure TSiSessionCore.LogFatal(const ATitle: UnicodeString);
begin
...
procedure TSiSessionCore.LogFatal(const ATitleFmt: UnicodeString;
  const AArgs: array of const);
begin
  if IsOn(lvFatal) then
  begin
...
procedure TSiSessionCore.LogInternalError(const ATitle: UnicodeString);
begin
  if IsOn(lvError) then
  begin
...
procedure TSiSessionCore.LogInternalError(const ATitleFmt: UnicodeString;
  const AArgs: array of const);
begin
  if IsOn(lvError) then
  begin
...
procedure TSiSessionCore.LogAssert(const ACondition: Boolean;
  const ATitle: UnicodeString);
begin
  if IsOn(lvError) then
  begin
...
procedure TSiSessionCore.LogAssigned(const ATitle: UnicodeString;
  const ARef: Pointer);
begin
  LogAssigned(FParent.DefaultLevel, ATitle, ARef);
end;

procedure TSiSessionCore.LogAssigned(const ALevel: TSiLevel;
...
procedure TSiSessionCore.AddCheckpoint;
begin
  AddCheckpoint(FParent.DefaultLevel);
end;

procedure TSiSessionCore.AddCheckpoint(const ALevel: TSiLevel);
var
  LTitle: UnicodeString;
  LCounter: Integer;
begin
  if IsOn(ALevel) then
  begin
    LCounter := AtomicIncrement(FCheckpointCounter);
    LTitle := SiFormat('Checkpoint #%d', [LCounter]);
    SendLogEntry(ALevel, LTitle, ltCheckpoint, viTitle);
  end;
end;

procedure TSiSessionCore.AddCheckpoint(const AName, ADetails: UnicodeString);
begin
  AddCheckpoint(FParent.DefaultLevel, AName, ADetails);
end;

procedure TSiSessionCore.AddCheckpoint(const ALevel: TSiLevel; const AName,
...
procedure TSiSessionCore.ResetCheckpoint;
begin
  FCheckpointCounter := 0;
end;

procedure TSiSessionCore.ResetCheckpoint(const AName: UnicodeString);
begin
  FCriticalSection.Enter;
  try
...
procedure TSiSessionCore.LogBoolean(const AName: UnicodeString;
  const AValue: Boolean);
begin
  LogBoolean(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogBoolean(const ALevel: TSiLevel;
...
procedure TSiSessionCore.LogByte(const AName: UnicodeString; const AValue: Byte);
begin
  LogByte(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogByte(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Byte);
begin
  LogByte(ALevel, AName, AValue, False);
end;

procedure TSiSessionCore.LogChar(const AName: UnicodeString; const AValue: Char);
begin
  LogChar(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogChar(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Char);
begin
  LogString(ALevel, AName, AValue);
end;

procedure TSiSessionCore.LogCurrency(const AName: UnicodeString;
  const AValue: Currency);
begin
  LogCurrency(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogCurrency(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Currency);
begin
  LogExtended(ALevel, AName, AValue);
end;

procedure TSiSessionCore.LogDateTime(const AName: UnicodeString;
  const AValue: TDateTime);
begin
  LogDateTime(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogDateTime(const ALevel: TSiLevel;
...
begin
  if IsOn(ALevel) then
  begin
    LTitle := AName + ' = ' + DateTimeToStr(AValue, TFormatSettings.Invariant);
    SendLogEntry(ALevel, LTitle, ltVariableValue, viTitle);
  end;
end;

procedure TSiSessionCore.LogDouble(const AName: UnicodeString; const AValue: Double);
begin
  LogDouble(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogDouble(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Double);
begin
  LogExtended(ALevel, AName, AValue);
end;

procedure TSiSessionCore.LogExtended(const AName: UnicodeString;
  const AValue: Extended);
begin
  LogExtended(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogExtended(const ALevel: TSiLevel;
...
begin
  if IsOn(ALevel) then
  begin
    LTitle := AName + ' = ' + FloatToStr(AValue, TFormatSettings.Invariant);
    SendLogEntry(ALevel, LTitle, ltVariableValue, viTitle);
  end;
end;

procedure TSiSessionCore.LogInt64(const AName: UnicodeString; const AValue: Int64);
begin
  LogInt64(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogInt64(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Int64);
begin
  LogInt64(ALevel, AName, AValue, False);
end;

procedure TSiSessionCore.LogUInt64(const AName: UnicodeString; const AValue: UInt64);
begin
  LogUInt64(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogUInt64(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: UInt64);
begin
  LogUInt64(ALevel, AName, AValue, False);
end;

procedure TSiSessionCore.LogInteger(const AName: UnicodeString; const AValue: Integer);
begin
  LogInteger(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogInteger(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Integer);
begin
  LogInteger(ALevel, AName, AValue, False);
end;

procedure TSiSessionCore.LogCardinal(const AName: UnicodeString;
  const AValue: Cardinal);
begin
  LogCardinal(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogCardinal(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Cardinal);
begin
  LogCardinal(ALevel, AName, AValue, False);
end;

procedure TSiSessionCore.LogPChar(const AName: UnicodeString; const AValue: PChar);
begin
  LogPChar(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogPChar(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: PChar);
begin
  LogString(ALevel, AName, AValue);
end;

procedure TSiSessionCore.LogPointer(const AName: UnicodeString;
  const AValue: Pointer);
begin
  LogPointer(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogPointer(const ALevel: TSiLevel;
...
begin
  if IsOn(ALevel) then
  begin
    {$IF SizeOf(Pointer) = 16}
    // %p cannot be used due to a bug in Delphi's Format
    LTitle := SiFormat('%s = $%.16x', [AName, UInt64(AValue)]);
    {$ELSE}
    // %p cannot be used due to a bug in Delphi's Format
    LTitle := SiFormat('%s = $%.8x', [AName, UInt32(AValue)]);
    {$ENDIF}
    SendLogEntry(ALevel, LTitle, ltVariableValue, viTitle);
  end;
end;
...
procedure TSiSessionCore.LogInt64(const AName: UnicodeString;
...
procedure TSiSessionCore.LogUInt64(const AName: UnicodeString;
  const AValue: UInt64; const AIncludeHex: Boolean);
begin
  LogUInt64(FParent.DefaultLevel, AName, AValue, AIncludeHex);
end;
...
begin
  if IsOn(ALevel) then
  begin
    LValue := UIntToStr(AValue);
    if AIncludeHex then
      LTitle := SiFormat('%s = %s ($%.16x)', [AName, LValue, AValue])
    else
      LTitle := SiFormat('%s = %s', [AName, LValue]);
    SendLogEntry(ALevel, LTitle, ltVariableValue, viTitle);
  end;
end;

procedure TSiSessionCore.LogInteger(const AName: UnicodeString;
...
procedure TSiSessionCore.LogShortint(const AName: UnicodeString;
  const AValue: Shortint; const AIncludeHex: Boolean);
begin
  LogShortint(FParent.DefaultLevel, AName, AValue, AIncludeHex);
end;

procedure TSiSessionCore.LogShortint(const ALevel: TSiLevel;
...
procedure TSiSessionCore.LogSmallint(const AName: UnicodeString;
  const AValue: Smallint; const AIncludeHex: Boolean);
begin
  LogSmallint(FParent.DefaultLevel, AName, AValue, AIncludeHex);
end;

procedure TSiSessionCore.LogSmallint(const ALevel: TSiLevel;
...
procedure TSiSessionCore.LogWord(const AName: UnicodeString;
  const AValue: Word; const AIncludeHex: Boolean);
begin
  LogWord(FParent.DefaultLevel, AName, AValue, AIncludeHex);
end;

procedure TSiSessionCore.LogWord(const ALevel: TSiLevel;
...
procedure TSiSessionCore.LogPWideChar(const AName: UnicodeString;
  const AValue: PWideChar);
begin
  LogPWideChar(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogPWideChar(const ALevel: TSiLevel;
...
procedure TSiSessionCore.LogSingle(const AName: UnicodeString; const AValue: Single);
begin
  LogSingle(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogSingle(const ALevel: TSiLevel;
...
procedure TSiSessionCore.LogString(const AName: UnicodeString; const AValue: String);
begin
  LogString(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogString(const ALevel: TSiLevel;
...
procedure TSiSessionCore.LogWideString(const AName: UnicodeString;
  const AValue: WideString);
begin
  LogWideString(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogWideString(const ALevel: TSiLevel;
...
procedure TSiSessionCore.LogWord(const AName: UnicodeString; const AValue: Word);
begin
...
procedure TSiSessionCore.LogValue(const AName: UnicodeString; const AValue: Smallint);
begin
  LogValue(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.LogValue(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Smallint);
begin
  LogSmallint(ALevel, AName, AValue);
end;

procedure TSiSessionCore.LogValue(const AName: UnicodeString; const AValue: Shortint);
begin
  LogValue(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.LogValue(const AName: UnicodeString; const AValue: Int64);
begin
  LogValue(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.LogValue(const AName: UnicodeString; const AValue: UInt64);
begin
  LogValue(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.LogValue(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: UInt64);
begin
  LogUInt64(ALevel, AName, AValue);
end;

procedure TSiSessionCore.LogValue(const AName: UnicodeString; const AValue: Byte);
begin
  LogValue(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.LogValue(const AName: UnicodeString; const AValue: Word);
begin
  LogValue(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.LogValue(const AName: UnicodeString; const AValue: Integer);
begin
  LogValue(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.LogValue(const AName: UnicodeString; const AValue: Cardinal);
begin
  LogValue(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.LogValue(const AName: UnicodeString; const AValue: String);
begin
  LogValue(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.LogValue(const AName: UnicodeString;
  const AValue: WideString);
begin
  LogValue(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.LogValue(const AName: UnicodeString; const AValue: PChar);
begin
  LogValue(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.LogValue(const AName: UnicodeString; const AValue: Boolean);
begin
  LogValue(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.LogValue(const AName: UnicodeString; const AValue: Extended);
begin
  LogValue(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.LogText(const ATitle, AText: UnicodeString);
begin
  LogText(FParent.DefaultLevel, ATitle, AText);
end;

procedure TSiSessionCore.LogText(const ALevel: TSiLevel;
  const ATitle, AText: UnicodeString);
begin
  LogCustomText(ALevel, ATitle, AText, ltText, viData);
end;

procedure TSiSessionCore.LogTextFile(const ATitle, AFileName: UnicodeString);
begin
  LogTextFile(FParent.DefaultLevel, ATitle, AFileName);
end;

procedure TSiSessionCore.LogTextFile(const ALevel: TSiLevel;
  const ATitle, AFileName: UnicodeString);
begin
  LogCustomFile(ALevel, ATitle, AFileName, ltText, viData);
end;

procedure TSiSessionCore.LogTextFile(const AFileName: UnicodeString);
begin
...
procedure TSiSessionCore.LogTextStream(const ATitle: UnicodeString;
  const AStream: TStream);
begin
  LogTextStream(FParent.DefaultLevel, ATitle, AStream);
end;

procedure TSiSessionCore.LogTextStream(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const AStream: TStream);
begin
  LogCustomStream(ALevel, ATitle, AStream, ltText, viData);
end;

procedure TSiSessionCore.LogHtml(const ATitle, AHtml: UnicodeString);
begin
  LogHtml(FParent.DefaultLevel, ATitle, AHtml);
end;

procedure TSiSessionCore.LogHtml(const ALevel: TSiLevel;
  const ATitle, AHtml: UnicodeString);
begin
  LogCustomText(ALevel, ATitle, AHtml, ltWebContent, viWeb);
end;

procedure TSiSessionCore.LogHtmlFile(const AFileName: UnicodeString);
begin
  LogHtmlFile(FParent.DefaultLevel, AFileName);
end;

procedure TSiSessionCore.LogHtmlFile(const ALevel: TSiLevel;
  const AFileName: UnicodeString);
begin
  LogCustomFile(ALevel, AFileName, ltWebContent, viWeb);
end;

procedure TSiSessionCore.LogHtmlFile(const ATitle, AFileName: UnicodeString);
begin
...
procedure TSiSessionCore.LogHtmlStream(const ATitle: UnicodeString;
  const AStream: TStream);
begin
  LogHtmlStream(FParent.DefaultLevel, ATitle, AStream);
end;

procedure TSiSessionCore.LogHtmlStream(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const AStream: TStream);
begin
  LogCustomStream(ALevel, ATitle, AStream, ltWebContent, viWeb);
end;

procedure TSiSessionCore.LogBinaryFile(const AFileName: UnicodeString);
begin
  LogBinaryFile(FParent.DefaultLevel, AFileName);
end;

procedure TSiSessionCore.LogBinaryFile(const ALevel: TSiLevel;
  const AFileName: UnicodeString);
begin
  LogCustomFile(ALevel, AFileName, ltBinary, viBinary);
end;

procedure TSiSessionCore.LogBinaryFile(const ATitle, AFileName: UnicodeString);
begin
...
procedure TSiSessionCore.LogBinaryStream(const ATitle: UnicodeString;
  const AStream: TStream);
begin
  LogBinaryStream(FParent.DefaultLevel, ATitle, AStream);
end;

procedure TSiSessionCore.LogBinaryStream(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const AStream: TStream);
begin
  LogCustomStream(ALevel, ATitle, AStream, ltBinary, viBinary);
end;

procedure TSiSessionCore.LogBitmapFile(const AFileName: UnicodeString);
begin
  LogBitmapFile(FParent.DefaultLevel, AFileName);
end;

procedure TSiSessionCore.LogBitmapFile(const ALevel: TSiLevel;
  const AFileName: UnicodeString);
begin
  LogCustomFile(ALevel, AFileName, ltGraphic, viBitmap);
end;

procedure TSiSessionCore.LogBitmapFile(const ATitle, AFileName: UnicodeString);
begin
...
procedure TSiSessionCore.LogBitmapStream(const ATitle: UnicodeString;
  const AStream: TStream);
begin
  LogBitmapStream(FParent.DefaultLevel, ATitle, AStream);
end;

procedure TSiSessionCore.LogBitmapStream(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const AStream: TStream);
begin
...
procedure TSiSessionCore.LogJpegFile(const ATitle, AFileName: UnicodeString);
begin
  LogJpegFile(FParent.DefaultLevel, ATitle, AFileName);
end;

procedure TSiSessionCore.LogJpegFile(const ALevel: TSiLevel;
  const ATitle, AFileName: UnicodeString);
begin
  LogCustomFile(ALevel, ATitle, AFileName, ltGraphic, viJpeg);
end;

procedure TSiSessionCore.LogJpegFile(const AFileName: UnicodeString);
begin
...
procedure TSiSessionCore.LogJpegStream(const ATitle: UnicodeString;
  const AStream: TStream);
begin
  LogJpegStream(FParent.DefaultLevel, ATitle, AStream);
end;

procedure TSiSessionCore.LogJpegStream(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const AStream: TStream);
begin
...
procedure TSiSessionCore.LogIconFile(const AFileName: UnicodeString);
begin
  LogIconFile(FParent.DefaultLevel, AFileName);
end;

procedure TSiSessionCore.LogIconFile(const ALevel: TSiLevel;
  const AFileName: UnicodeString);
begin
  LogCustomFile(ALevel, AFileName, ltGraphic, viIcon);
end;

procedure TSiSessionCore.LogIconFile(const ATitle, AFileName: UnicodeString);
begin
...
procedure TSiSessionCore.LogIconStream(const ATitle: UnicodeString;
  const AStream: TStream);
begin
  LogIconStream(FParent.DefaultLevel, ATitle, AStream);
end;

procedure TSiSessionCore.LogIconStream(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const AStream: TStream);
begin
...
procedure TSiSessionCore.LogMetafileFile(const AFileName: UnicodeString);
begin
  LogMetafileFile(FParent.DefaultLevel, AFileName);
end;

procedure TSiSessionCore.LogMetafileFile(const ALevel: TSiLevel;
  const AFileName: UnicodeString);
begin
  LogCustomFile(ALevel, AFileName, ltGraphic, viMetafile);
end;

procedure TSiSessionCore.LogMetafileFile(const ATitle, AFileName: UnicodeString);
begin
...
procedure TSiSessionCore.LogMetafileStream(const ATitle: UnicodeString;
  const AStream: TStream);
begin
  LogMetafileStream(FParent.DefaultLevel, ATitle, AStream);
end;

procedure TSiSessionCore.LogMetafileStream(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const AStream: TStream);
begin
...
procedure TSiSessionCore.LogCustomText(const ATitle, AText: UnicodeString;
  const ALogEntryType: TSiLogEntryType; const AViewerId: TSiViewerId);
begin
  LogCustomText(FParent.DefaultLevel, ATitle, AText, ALogEntryType, AViewerId);
end;

procedure TSiSessionCore.LogCustomText(const ALevel: TSiLevel;
  const ATitle, AText: UnicodeString; const ALogEntryType: TSiLogEntryType;
  const AViewerId: TSiViewerId);
var
...
procedure TSiSessionCore.LogCustomContext(const ATitle: UnicodeString;
...
procedure TSiSessionCore.LogCustomContext(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const ALogEntryType: TSiLogEntryType;
  const AContext: TSiViewerContext);
begin
  if IsOn(ALevel) then
...
procedure TSiSessionCore.SendContext(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const ALogEntryType: TSiLogEntryType;
  const AContext: TSiViewerContext);
begin
...
procedure TSiSessionCore.SendControlCommand(
...
procedure TSiSessionCore.SendLogEntry(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const ALogEntryType: TSiLogEntryType;
  const AViewerId: TSiViewerId);
begin
...
begin
  ...
  try
    ...
    LLogEntry.Color := SiDefaultColor;
    //    if AColor = SiDefaultColor then
    //      LLogEntry.Color := AColor { Transparent }
    //    else
    //      LLogEntry.Color := SiColorToRGB(AColor) and $FFFFFF;
...
procedure TSiSessionCore.SendProcessFlow(const ALevel: TSiLevel;
...
procedure TSiSessionCore.SendWatch(const ALevel: TSiLevel;
...
procedure TSiSessionCore.LogCustomFile(const AFileName: UnicodeString;
  const ALogEntryType: TSiLogEntryType; const AViewerId: TSiViewerId);
begin
  LogCustomFile(FParent.DefaultLevel, AFileName, ALogEntryType, AViewerId);
end;

procedure TSiSessionCore.LogCustomFile(const ALevel: TSiLevel;
  const AFileName: UnicodeString; const ALogEntryType: TSiLogEntryType;
  const AViewerId: TSiViewerId);
begin
...
procedure TSiSessionCore.LogCustomFile(const ATitle, AFileName: UnicodeString;
  const ALogEntryType: TSiLogEntryType; const AViewerId: TSiViewerId);
begin
...
procedure TSiSessionCore.LogCustomStream(const ATitle: UnicodeString;
  const AStream: TStream; const ALogEntryType: TSiLogEntryType;
  const AViewerId: TSiViewerId);
begin
...
procedure TSiSessionCore.LogCustomStream(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const AStream: TStream;
  const ALogEntryType: TSiLogEntryType; const AViewerId: TSiViewerId);
var
  LContext: TSiBinaryContext;
...
procedure TSiSessionCore.LogSql(const ATitle, ASource: UnicodeString);
begin
  LogSql(FParent.DefaultLevel, ATitle, ASource);
end;

procedure TSiSessionCore.LogSql(const ALevel: TSiLevel;
  const ATitle, ASource: UnicodeString);
begin
  LogSource(ALevel, ATitle, ASource, siSql);
end;

procedure TSiSessionCore.LogSource(const ATitle, ASource: UnicodeString;
  const AId: TSiSourceId);
begin
  LogSource(FParent.DefaultLevel, ATitle, ASource, AId);
end;

procedure TSiSessionCore.LogSource(const ALevel: TSiLevel;
...
procedure TSiSessionCore.LogSourceFile(const AFileName: UnicodeString;
  const AId: TSiSourceId);
begin
  LogSourceFile(FParent.DefaultLevel, AFileName, AId);
end;

procedure TSiSessionCore.LogSourceFile(const ALevel: TSiLevel;
  const AFileName: UnicodeString; const AId: TSiSourceId);
begin
  LogCustomFile(ALevel, AFileName, ltSource, CSiSourceIdLookup[AId]);
end;

procedure TSiSessionCore.LogSourceFile(const ATitle, AFileName: UnicodeString;
  const AId: TSiSourceId);
begin
...
procedure TSiSessionCore.LogSourceStream(const ATitle: UnicodeString;
  const AStream: TStream; const AId: TSiSourceId);
begin
  LogSourceStream(FParent.DefaultLevel, ATitle, AStream, AId);
end;

procedure TSiSessionCore.LogSourceStream(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const AStream: TStream;
  const AId: TSiSourceId);
begin
...
procedure TSiSessionCore.LogMemory(const ATitle: UnicodeString;
  const AAddress: Pointer; const ASize: Integer);
begin
  LogMemory(FParent.DefaultLevel, ATitle, AAddress, ASize);
end;

procedure TSiSessionCore.LogMemory(const ALevel: TSiLevel;
...
procedure TSiSessionCore.LogStream(const ATitle: UnicodeString;
  const AStream: TStream);
begin
  LogStream(FParent.DefaultLevel, ATitle, AStream);
end;

procedure TSiSessionCore.LogStream(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const AStream: TStream);
begin
  LogBinaryStream(ALevel, ATitle, AStream);
end;

procedure TSiSessionCore.LogException(const ATitle: UnicodeString = '');
var
  E: TObject;
...
procedure TSiSessionCore.LogException(const AException: Exception;
  const ATitle: UnicodeString = '');
var
  LTitle: UnicodeString;
  LErrorMessage: String;
...
procedure TSiSessionCore.LogStringList(const ATitle: UnicodeString;
  const AStrings: TStrings);
begin
  LogStringList(FParent.DefaultLevel, ATitle, AStrings);
end;

procedure TSiSessionCore.LogStringList(const ALevel: TSiLevel;
...
procedure TSiSessionCore.LogLastError(const ATitle: UnicodeString;
  const AIgnoreSuccess: Boolean = False);
begin
  if IsOn(lvError) then
  begin
...
procedure TSiSessionCore.LogWin32Error(const ATitle: UnicodeString;
  const AErrorCode: DWord; const AIgnoreSuccess: Boolean = False);
var
  LTitle: UnicodeString;
begin
...
procedure TSiSessionCore.ClearAll;
begin
  if IsOn then
  begin
...
procedure TSiSessionCore.ClearAutoViews;
begin
  if IsOn then
  begin
...
procedure TSiSessionCore.ClearWatches;
begin
  if IsOn then
  begin
...
procedure TSiSessionCore.ClearLog;
begin
  if IsOn then
  begin
...
procedure TSiSessionCore.ClearProcessFlow;
begin
  if IsOn then
  begin
...
procedure TSiSessionCore.WatchBoolean(const AName: UnicodeString;
  const AValue: Boolean);
begin
  WatchBoolean(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchBoolean(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Boolean);
begin
  if IsOn(ALevel) then
  begin
...
procedure TSiSessionCore.WatchChar(const AName: UnicodeString; const AValue: Char);
begin
  WatchChar(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchChar(const ALevel: TSiLevel; const AName: UnicodeString;
  const AValue: Char);
begin
  if IsOn(ALevel) then
  begin
...
procedure TSiSessionCore.IncCounter(const AName: UnicodeString);
begin
  IncCounter(FParent.DefaultLevel, AName);
end;

procedure TSiSessionCore.IncCounter(const ALevel: TSiLevel;
  const AName: UnicodeString);
var
  LValue: Integer;
begin
...
procedure TSiSessionCore.WatchDateTime(const AName: UnicodeString;
  const AValue: TDateTime);
begin
  WatchDateTime(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchDateTime(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: TDateTime);
var
  LValue: UnicodeString;
begin
...
procedure TSiSessionCore.WatchPointer(const AName: UnicodeString;
  const AValue: Pointer);
begin
  WatchPointer(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchPointer(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Pointer);
var
  LValue: UnicodeString;
begin
  ...
  begin
    {$IF SizeOf(Pointer) = 16}
    // %p cannot be used due to a bug in Delphi's Format
    LValue := SiFormat('$%.16x', [UInt64(AValue)]);
    {$ELSE}
    // %p cannot be used due to a bug in Delphi's Format
    LValue := SiFormat('$%.8x', [UInt32(AValue)]);
    {$ENDIF}
    SendWatch(ALevel, AName, LValue, wtAddress);
  end;
end;

procedure TSiSessionCore.WatchInteger(const AName: UnicodeString;
  const AValue: Integer);
begin
  WatchInteger(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchInteger(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Integer);
begin
  WatchInteger(ALevel, AName, AValue, False);
end;

procedure TSiSessionCore.WatchCardinal(const AName: UnicodeString;
  const AValue: Cardinal);
begin
  WatchCardinal(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchCardinal(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Cardinal);
begin
  WatchCardinal(ALevel, AName, AValue, False);
end;

procedure TSiSessionCore.WatchString(const AName: UnicodeString;
  const AValue: String);
begin
  WatchString(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchString(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: String);
begin
  if IsOn(ALevel) then
  begin
...
procedure TSiSessionCore.WatchByte(const AName: UnicodeString; const AValue: Byte;
  const AIncludeHex: Boolean);
begin
  WatchByte(FParent.DefaultLevel, AName, AValue, AIncludeHex);
end;

procedure TSiSessionCore.WatchByte(const ALevel: TSiLevel;
...
procedure TSiSessionCore.WatchInt64(const AName: UnicodeString; const AValue: Int64;
  const AIncludeHex: Boolean);
begin
  WatchInt64(FParent.DefaultLevel, AName, AValue, AIncludeHex);
end;

procedure TSiSessionCore.WatchInt64(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Int64;
  const AIncludeHex: Boolean);
var
  LValue: UnicodeString;
...
procedure TSiSessionCore.WatchUInt64(const AName: UnicodeString; const AValue: UInt64;
  const AIncludeHex: Boolean);
begin
  WatchUInt64(FParent.DefaultLevel, AName, AValue, AIncludeHex);
end;

procedure TSiSessionCore.WatchUInt64(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: UInt64;
  const AIncludeHex: Boolean);
var
  LValue: UnicodeString;
begin
  ...
  begin
    if AIncludeHex then
      LValue := SiFormat('%s ($%.16x)', [UIntToStr(AValue), AValue])
    else
      LValue := UIntToStr(AValue);
    SendWatch(ALevel, AName, LValue, wtInteger);
  end;
...
procedure TSiSessionCore.WatchShortint(const AName: UnicodeString;
  const AValue: Shortint; const AIncludeHex: Boolean);
begin
  WatchShortint(FParent.DefaultLevel, AName, AValue, AIncludeHex);
end;

procedure TSiSessionCore.WatchShortint(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Shortint;
  const AIncludeHex: Boolean);
var
  LValue: UnicodeString;
...
procedure TSiSessionCore.WatchSmallint(const AName: UnicodeString;
  const AValue: Smallint; const AIncludeHex: Boolean);
begin
  WatchSmallint(FParent.DefaultLevel, AName, AValue, AIncludeHex);
end;

procedure TSiSessionCore.WatchSmallint(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Smallint;
  const AIncludeHex: Boolean);
var
  LValue: UnicodeString;
...
procedure TSiSessionCore.WatchWord(const AName: UnicodeString; const AValue: Word;
  const AIncludeHex: Boolean);
begin
  WatchWord(FParent.DefaultLevel, AName, AValue, AIncludeHex);
end;

procedure TSiSessionCore.WatchWord(const ALevel: TSiLevel;
...
procedure TSiSessionCore.WatchByte(const ALevel: TSiLevel; const AName: UnicodeString;
  const AValue: Byte);
begin
...
procedure TSiSessionCore.WatchUInt64(const AName: UnicodeString; const AValue: UInt64);
begin
  WatchUInt64(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchUInt64(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: UInt64);
begin
  WatchUInt64(ALevel, AName, AValue, False);
end;
...
procedure TSiSessionCore.WatchWord(const ALevel: TSiLevel; const AName: UnicodeString;
  const AValue: Word);
begin
  WatchWord(ALevel, AName, AValue, False);
end;

procedure TSiSessionCore.WatchCurrency(const AName: UnicodeString;
  const AValue: Currency);
begin
  WatchCurrency(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchCurrency(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Currency);
begin
  WatchExtended(ALevel, AName, AValue);
end;

procedure TSiSessionCore.WatchDouble(const AName: UnicodeString;
  const AValue: Double);
begin
  WatchDouble(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchDouble(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Double);
begin
  WatchExtended(ALevel, AName, AValue);
end;

procedure TSiSessionCore.WatchExtended(const AName: UnicodeString;
  const AValue: Extended);
begin
  WatchExtended(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchExtended(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Extended);
var
  LValue: UnicodeString;
begin
...
procedure TSiSessionCore.WatchSingle(const AName: UnicodeString;
  const AValue: Single);
begin
  WatchSingle(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchSingle(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: Single);
begin
  WatchExtended(ALevel, AName, AValue);
end;

procedure TSiSessionCore.WatchPChar(const AName: UnicodeString; const AValue: PChar);
begin
  WatchPChar(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchPChar(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: PChar);
begin
  WatchString(ALevel, AName, AValue);
end;

procedure TSiSessionCore.WatchWideString(const AName: UnicodeString;
  const AValue: WideString);
begin
  WatchWideString(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchWideString(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: WideString);
begin
  if IsOn(ALevel) then
  begin
...
procedure TSiSessionCore.WatchPWideChar(const AName: UnicodeString;
  const AValue: PWideChar);
begin
  WatchPWideChar(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.WatchPWideChar(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: PWideChar);
begin
  WatchWideString(ALevel, AName, AValue);
end;

procedure TSiSessionCore.Watch(const AName: UnicodeString; const AValue: Smallint);
begin
  Watch(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.Watch(const ALevel: TSiLevel; const AName: UnicodeString;
  const AValue: Smallint);
begin
  WatchSmallint(ALevel, AName, AValue);
end;

procedure TSiSessionCore.Watch(const AName: UnicodeString; const AValue: Shortint);
begin
  Watch(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.Watch(const AName: UnicodeString; const AValue: Int64);
begin
  Watch(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.Watch(const AName: UnicodeString; const AValue: UInt64);
begin
  Watch(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.Watch(const ALevel: TSiLevel; const AName: UnicodeString;
  const AValue: UInt64);
begin
  WatchUInt64(ALevel, AName, AValue);
end;

procedure TSiSessionCore.Watch(const AName: UnicodeString; const AValue: Byte);
begin
  Watch(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.Watch(const AName: UnicodeString; const AValue: Word);
begin
  Watch(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.Watch(const AName: UnicodeString; const AValue: Integer);
begin
  Watch(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.Watch(const AName: UnicodeString; const AValue: String);
begin
  Watch(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.Watch(const AName: UnicodeString; const AValue: WideString);
begin
  Watch(FParent.DefaultLevel, AName, AValue);
end;

procedure TSiSessionCore.Watch(const ALevel: TSiLevel;
  const AName: UnicodeString; const AValue: WideString);
begin
  WatchWideString(ALevel, AName, AValue);
end;

procedure TSiSessionCore.Watch(const AName: UnicodeString; const AValue: PWideChar);
begin
  Watch(FParent.DefaultLevel, AName, AValue);
end;
...
//procedure TSiSessionCore.Watch(const AName: UnicodeString; const AValue: PChar);
//begin
//  Watch(FParent.DefaultLevel, AName, AValue);
//end;
//
...
procedure TSiSessionCore.Watch(const AName: UnicodeString; const AValue: Cardinal);
begin
  Watch(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.Watch(const AName: UnicodeString; const AValue: Boolean);
begin
  Watch(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.Watch(const AName: UnicodeString; const AValue: Extended);
begin
  Watch(FParent.DefaultLevel, AName, AValue);
end;
...
procedure TSiSessionCore.SendCustomControlCommand(
  const AControlCommandType: TSiControlCommandType; const AData: TStream);
begin
  SendCustomControlCommand(FParent.DefaultLevel, AControlCommandType, AData);
end;

procedure TSiSessionCore.SendCustomControlCommand(const ALevel: TSiLevel;
  const AControlCommandType: TSiControlCommandType; const AData: TStream);
var
  LOldPosition: Int64;
begin
...
procedure TSiSessionCore.SendCustomLogEntry(const ATitle: UnicodeString;
  const ALogEntryType: TSiLogEntryType;
...
procedure TSiSessionCore.SendCustomLogEntry(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const ALogEntryType: TSiLogEntryType;
  const AViewerId: TSiViewerId; const AData: TStream);
begin
  if IsOn(ALevel) then
...
procedure TSiSessionCore.SendCustomProcessFlow(const ATitle: UnicodeString;
  const AProcessFlowType: TSiProcessFlowType);
begin
  SendCustomProcessFlow(FParent.DefaultLevel, ATitle, AProcessFlowType);
end;

procedure TSiSessionCore.SendCustomProcessFlow(const ALevel: TSiLevel;
  const ATitle: UnicodeString; const AProcessFlowType: TSiProcessFlowType);
begin
  if IsOn(ALevel) then
  begin
...
procedure TSiSessionCore.SendCustomWatch(const AName, AValue: UnicodeString;
  const AWatchType: TSiWatchType);
begin
  SendCustomWatch(FParent.DefaultLevel, AName, AValue, AWatchType);
end;

procedure TSiSessionCore.SendCustomWatch(const ALevel: TSiLevel;
  const AName, AValue: UnicodeString; const AWatchType: TSiWatchType);
begin
  if IsOn(ALevel) then
  begin
...
function TSiSessionCore.TrackMethod(const AMethodNameFmt: UnicodeString;
...
function TSiSessionCore.TrackMethod(const AInstance: TObject;
  const AMethodName: UnicodeString): ISiMethodTracker;
begin
...
function TSiSessionCore.UpdateCounter(const AName: UnicodeString;
  const AIncrement: Boolean): Integer;
begin
  FCriticalSection.Enter;
  try
...
constructor TSiMethodTracker.Create(const ALevel: TSiLevel;
  const ASession: TSiSessionCore; const AMethodName: UnicodeString);
begin
  FSession := ASession;
...
begin
  ...
  Move(LUTF8, Result, Length(LUTF8));
end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Move(LBuffer, Result, Length(LBuffer));
      end;
...
begin
  ...
  begin
    ...
    {$Message Warn 'todo'}
    Move(AString, P, LLength * SizeOf(WideChar));
    Inc(FCount, LLength);
  end;
end;
...
procedure TSiSessionManager.Add(const ASession: TSiSessionCore;
...
procedure TSiSessionManager.Assign(const ASession: TSiSessionCore;
...
procedure TSiSessionManager.Configure(const ASession: TSiSessionCore;
  const AName: UnicodeString);
var
...
procedure TSiSessionManager.Delete(const ASession: TSiSessionCore);
begin
  if not Assigned(ASession) then
  begin
    Exit;
...
function TSiSessionManager.Get(const AName: UnicodeString): TSiSessionCore;
begin
  FCriticalSection.Enter;
  try
    Result := TSiSessionCore(FSessionTable[AName]);
  finally
    FCriticalSection.Leave;
  end;
end;
...
begin
  ...
  begin
    ...
    LSession := TSiSessionCore(FSessionTable[LName]);
...
procedure TSiSessionManager.Update(const ASession: TSiSessionCore;
  const ATo, AFrom: UnicodeString);
begin
  if not Assigned(ASession) then
  begin
...
procedure TSiSessionDefaults.Assign(const ASession: TSiSessionCore);
begin
...
begin
  ...
  FNotFull := TEvent.Create(nil, False, True, string.Empty);
  FNotEmpty := TEvent.Create(nil, False, False, string.Empty);
  FProtocol := AProtocol;
...
function TSiStringBuilder.Count: Integer;
begin
  Result := Length;
end;

function TSiStringBuilder.Text: UnicodeString;
begin
  Result := ToString;
end;
