...
//
  ...
  {$EXTERNALSYM NCRYPT_KEY_PROTECTION_ALGORITHM_LOCKEDCREDENTIALS}
//
// LOCKEDCREDENTIALS=%ProtectionDomain%[,%EnterpriseID%]
//

  NCRYPT_KEY_PROTECTION_ALGORITHM_CERTIFICATE = 'CERTIFICATE';
  {$EXTERNALSYM NCRYPT_KEY_PROTECTION_ALGORITHM_CERTIFICATE}
...
//
  ...
  {$EXTERNALSYM NCRYPT_KEY_PROTECTION_CERT_CERTBLOB}
//
...
****************************************************************************)
type
  PFNCryptStreamOutputCallbackEx = function(
    pvCallbackCtxt: Pointer;
    pbData: PByte;
    cbData: SIZE_T;
    hDescriptor: NCRYPT_DESCRIPTOR_HANDLE;
    fFinal: BOOL): SECURITY_STATUS; winapi;
  {$EXTERNALSYM PFNCryptStreamOutputCallbackEx}
  TFnCryptStreamOutputCallbackEx = PFNCryptStreamOutputCallbackEx;
...
****************************************************************************)
type
  PNCryptProtectStreamInfoEx = ^TNCryptProtectStreamInfoEx;
  NCRYPT_PROTECT_STREAM_INFO_EX = record
    pfnStreamOutput: PFNCryptStreamOutputCallbackEx;
    pvCallbackCtxt: Pointer;
  end;
  {$EXTERNALSYM NCRYPT_PROTECT_STREAM_INFO_EX}
  TNCryptProtectStreamInfoEx = NCRYPT_PROTECT_STREAM_INFO_EX;
...
function NCryptStreamOpenToUnprotectEx(
  const pStreamInfo: TNCryptProtectStreamInfoEx;
  dwFlags: DWORD;
  hWnd: HWND;
  out phStream: NCRYPT_STREAM_HANDLE): SECURITY_STATUS; winapi;
{$EXTERNALSYM NCryptStreamOpenToUnprotectEx}
...
function NCryptStreamOpenToUnprotectEx; external NCryptDll name 'NCryptStreamOpenToUnprotectEx' delayed;
